...
// <<< Don't Change
    public static class TitleCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
        	...
        	StringTokenizer string_token = new StringTokenizer(line, delimiters);
        	while(string_token.hasMoreTokens())
        	{
        		String next_token = string_token.nextToken().toLowerCase();
                if (!stopWords.contains(next_token)) {
                    context.write(new Text(next_token), new IntWritable(1));
        		}
        	}
        }
    }
